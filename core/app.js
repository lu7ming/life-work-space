...
const MODULE_REGISTRY = {
  dashboard:   { js: '../modules/dashboard/dashboard.js?v=90',   html: 'dashboard/dashboard.html',   css: 'dashboard/dashboard.css' },
  habits:      { js: '../modules/habits/habits.js?v=90',         html: 'habits/habits.html',         css: 'habits/habits.css' },
  tasks:       { js: '../modules/tasks/tasks.js?v=90',           html: 'tasks/tasks.html',           css: 'tasks/tasks.css' },
  study:       { js: '../modules/study/study.js?v=90',           html: 'study/study.html',           css: 'study/study.css' },
  health:      { js: '../modules/health/health.js?v=90',         html: 'health/health.html',         css: 'health/health.css' },
  finance:     { js: '../modules/finance/finance.js?v=90',       html: 'finance/finance.html',       css: 'finance/finance.css' },
  journal:     { js: '../modules/journal/journal.js?v=90',       html: 'journal/journal.html',       css: 'journal/journal.css' },
  relations:   { js: '../modules/relations/relations.js?v=90',   html: 'relations/relations.html',   css: 'relations/relations.css' },
  knowledge:   { js: '../modules/knowledge/knowledge.js?v=90',   html: 'knowledge/knowledge.html',   css: 'knowledge/knowledge.css' },
  goals:       { js: '../modules/goals/goals.js?v=90',           html: 'goals/goals.html',           css: 'goals/goals.css' },
  lifetree:    { js: '../modules/lifetree/lifetree.js?v=90',     html: 'lifetree/lifetree.html',     css: 'lifetree/lifetree.css' },
  content:     { js: '../modules/content/content.js?v=90',       html: 'content/content.html',       css: 'content/content.css' },
  achievements:{ js: '../modules/achievements/achievements.js?v=90', html: 'achievements/achievements.html', css: 'achievements/achievements.css' },
  timetracker: { js: '../modules/timetracker/timetracker.js?v=90', html: 'timetracker/timetracker.html', css: 'timetracker/timetracker.css' },
  templates:   { js: '../modules/templates/templates_module.js?v=90', html: 'templates/templates.html' },
  calendar:    { js: '../modules/calendar/calendar.js?v=90',        html: 'calendar/calendar.html',     css: 'calendar/calendar.css' },
  toolbox:     { js: '../modules/toolbox/toolbox.js?v=90',          html: 'toolbox/toolbox.html',        css: 'toolbox/toolbox.css' },
  travel:      { js: '../modules/travel/travel.js?v=90',           html: 'travel/travel.html',           css: 'travel/travel.css' },
};
...
async function lazyImport(name) {
  ...
  const pathMap = {
    secureStorage: './secure-storage.js?v=90',
    theme: './theme.js?v=90',
    bgEffects: './bg-effects.js?v=90',
    notifications: './notifications.js?v=90',
    smartReminder: './smart-reminder.js?v=90',
    templates: './templates.js?v=90',
    userProfile: './user-profile.js?v=90',
    preferenceLearner: './preference-learner.js?v=90',
    predictiveEngine: './predictive-engine.js?v=90',
    auditLog: './audit-log.js?v=90',
    localAI: './local-ai.js?v=90',
    quickinput: './quickinput.js?v=90',
    sharedKnowledge: './shared-knowledge.js?v=90',
    orchestrator: './orchestrator.js?v=90',
    modelRouter: './model-router.js?v=90',
    smartSuggestion: './smart-suggestion.js?v=90',
    crossLinker: './cross-linker.js?v=90',
    sync: './sync.js?v=90',
    search: './search.js?v=90',
    export: './export.js?v=90',
    emotionAnalyzer: './emotion-analyzer.js?v=90',
    dataMinimizer: './data-minimizer.js?v=90',
    knowledgeExtractor: './knowledge-extractor.js?v=90',
    nicole: './nicole.js?v=90',
    xiaolu: './xiaolu.js?v=90',
    music: '../modules/music/music.js?v=90',
    report: '../modules/report/report.js?v=90',
    rest: '../modules/rest/rest.js?v=90',
    achievements: './achievements.js?v=90',
  };
