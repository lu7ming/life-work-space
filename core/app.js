...
const MODULE_REGISTRY = {
  dashboard:   { js: '../modules/dashboard/dashboard.js?v=80',   html: 'dashboard/dashboard.html',   css: 'dashboard/dashboard.css' },
  habits:      { js: '../modules/habits/habits.js?v=80',         html: 'habits/habits.html',         css: 'habits/habits.css' },
  tasks:       { js: '../modules/tasks/tasks.js?v=80',           html: 'tasks/tasks.html',           css: 'tasks/tasks.css' },
  study:       { js: '../modules/study/study.js?v=80',           html: 'study/study.html',           css: 'study/study.css' },
  health:      { js: '../modules/health/health.js?v=80',         html: 'health/health.html',         css: 'health/health.css' },
  finance:     { js: '../modules/finance/finance.js?v=80',       html: 'finance/finance.html',       css: 'finance/finance.css' },
  journal:     { js: '../modules/journal/journal.js?v=80',       html: 'journal/journal.html',       css: 'journal/journal.css' },
  relations:   { js: '../modules/relations/relations.js?v=80',   html: 'relations/relations.html',   css: 'relations/relations.css' },
  knowledge:   { js: '../modules/knowledge/knowledge.js?v=80',   html: 'knowledge/knowledge.html',   css: 'knowledge/knowledge.css' },
  goals:       { js: '../modules/goals/goals.js?v=80',           html: 'goals/goals.html',           css: 'goals/goals.css' },
  lifetree:    { js: '../modules/lifetree/lifetree.js?v=80',     html: 'lifetree/lifetree.html',     css: 'lifetree/lifetree.css' },
  content:     { js: '../modules/content/content.js?v=80',       html: 'content/content.html',       css: 'content/content.css' },
  achievements:{ js: '../modules/achievements/achievements.js?v=80', html: 'achievements/achievements.html', css: 'achievements/achievements.css' },
  timetracker: { js: '../modules/timetracker/timetracker.js?v=80', html: 'timetracker/timetracker.html', css: 'timetracker/timetracker.css' },
  templates:   { js: '../modules/templates/templates_module.js?v=80', html: 'templates/templates.html' },
  calendar:    { js: '../modules/calendar/calendar.js?v=80',        html: 'calendar/calendar.html',     css: 'calendar/calendar.css' },
  toolbox:     { js: '../modules/toolbox/toolbox.js?v=80',          html: 'toolbox/toolbox.html',        css: 'toolbox/toolbox.css' },
};
...
async function lazyImport(name) {
  ...
  const pathMap = {
    secureStorage: './secure-storage.js?v=80',
    theme: './theme.js?v=80',
    bgEffects: './bg-effects.js?v=80',
    notifications: './notifications.js?v=80',
    smartReminder: './smart-reminder.js?v=80',
    templates: './templates.js?v=80',
    userProfile: './user-profile.js?v=80',
    preferenceLearner: './preference-learner.js?v=80',
    predictiveEngine: './predictive-engine.js?v=80',
    auditLog: './audit-log.js?v=80',
    localAI: './local-ai.js?v=80',
    quickinput: './quickinput.js?v=80',
    sharedKnowledge: './shared-knowledge.js?v=80',
    orchestrator: './orchestrator.js?v=80',
    modelRouter: './model-router.js?v=80',
    smartSuggestion: './smart-suggestion.js?v=80',
    crossLinker: './cross-linker.js?v=80',
    sync: './sync.js?v=80',
    search: './search.js?v=80',
    export: './export.js?v=80',
    emotionAnalyzer: './emotion-analyzer.js?v=80',
    dataMinimizer: './data-minimizer.js?v=80',
    knowledgeExtractor: './knowledge-extractor.js?v=80',
    nicole: './nicole.js?v=80',
    xiaolu: './xiaolu.js?v=80',
    music: '../modules/music/music.js?v=80',
    report: '../modules/report/report.js?v=80',
    rest: '../modules/rest/rest.js?v=80',
    achievements: './achievements.js?v=80',
  };
