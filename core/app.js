...
const MODULE_REGISTRY = {
  dashboard:   { js: '../modules/dashboard/dashboard.js?v=93',   html: 'dashboard/dashboard.html',   css: 'dashboard/dashboard.css' },
  habits:      { js: '../modules/habits/habits.js?v=93',         html: 'habits/habits.html',         css: 'habits/habits.css' },
  tasks:       { js: '../modules/tasks/tasks.js?v=93',           html: 'tasks/tasks.html',           css: 'tasks/tasks.css' },
  study:       { js: '../modules/study/study.js?v=93',           html: 'study/study.html',           css: 'study/study.css' },
  health:      { js: '../modules/health/health.js?v=93',         html: 'health/health.html',         css: 'health/health.css' },
  finance:     { js: '../modules/finance/finance.js?v=93',       html: 'finance/finance.html',       css: 'finance/finance.css' },
  journal:     { js: '../modules/journal/journal.js?v=93',       html: 'journal/journal.html',       css: 'journal/journal.css' },
  relations:   { js: '../modules/relations/relations.js?v=93',   html: 'relations/relations.html',   css: 'relations/relations.css' },
  knowledge:   { js: '../modules/knowledge/knowledge.js?v=93',   html: 'knowledge/knowledge.html',   css: 'knowledge/knowledge.css' },
  goals:       { js: '../modules/goals/goals.js?v=93',           html: 'goals/goals.html',           css: 'goals/goals.css' },
  lifetree:    { js: '../modules/lifetree/lifetree.js?v=93',     html: 'lifetree/lifetree.html',     css: 'lifetree/lifetree.css' },
  content:     { js: '../modules/content/content.js?v=93',       html: 'content/content.html',       css: 'content/content.css' },
  achievements:{ js: '../modules/achievements/achievements.js?v=93', html: 'achievements/achievements.html', css: 'achievements/achievements.css' },
  timetracker: { js: '../modules/timetracker/timetracker.js?v=93', html: 'timetracker/timetracker.html', css: 'timetracker/timetracker.css' },
  templates:   { js: '../modules/templates/templates_module.js?v=93', html: 'templates/templates.html' },
  calendar:    { js: '../modules/calendar/calendar.js?v=93',        html: 'calendar/calendar.html',     css: 'calendar/calendar.css' },
  toolbox:     { js: '../modules/toolbox/toolbox.js?v=93',          html: 'toolbox/toolbox.html',        css: 'toolbox/toolbox.css' },
  travel:      { js: '../modules/travel/travel.js?v=93',           html: 'travel/travel.html',           css: 'travel/travel.css' },
};
...
async function lazyImport(name) {
  ...
  const pathMap = {
    secureStorage: './secure-storage.js?v=93',
    theme: './theme.js?v=93',
    bgEffects: './bg-effects.js?v=93',
    notifications: './notifications.js?v=93',
    smartReminder: './smart-reminder.js?v=93',
    templates: './templates.js?v=93',
    userProfile: './user-profile.js?v=93',
    preferenceLearner: './preference-learner.js?v=93',
    predictiveEngine: './predictive-engine.js?v=93',
    auditLog: './audit-log.js?v=93',
    localAI: './local-ai.js?v=93',
    quickinput: './quickinput.js?v=93',
    sharedKnowledge: './shared-knowledge.js?v=93',
    orchestrator: './orchestrator.js?v=93',
    modelRouter: './model-router.js?v=93',
    smartSuggestion: './smart-suggestion.js?v=93',
    crossLinker: './cross-linker.js?v=93',
    sync: './sync.js?v=93',
    search: './search.js?v=93',
    export: './export.js?v=93',
    emotionAnalyzer: './emotion-analyzer.js?v=93',
    dataMinimizer: './data-minimizer.js?v=93',
    knowledgeExtractor: './knowledge-extractor.js?v=93',
    nicole: './nicole.js?v=93',
    xiaolu: './xiaolu.js?v=93',
    music: '../modules/music/music.js?v=93',
    report: '../modules/report/report.js?v=93',
    rest: '../modules/rest/rest.js?v=93',
    achievements: './achievements.js?v=93',
  };
