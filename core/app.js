...
const MODULE_REGISTRY = {
  dashboard:   { js: '../modules/dashboard/dashboard.js?v=92',   html: 'dashboard/dashboard.html',   css: 'dashboard/dashboard.css' },
  habits:      { js: '../modules/habits/habits.js?v=92',         html: 'habits/habits.html',         css: 'habits/habits.css' },
  tasks:       { js: '../modules/tasks/tasks.js?v=92',           html: 'tasks/tasks.html',           css: 'tasks/tasks.css' },
  study:       { js: '../modules/study/study.js?v=92',           html: 'study/study.html',           css: 'study/study.css' },
  health:      { js: '../modules/health/health.js?v=92',         html: 'health/health.html',         css: 'health/health.css' },
  finance:     { js: '../modules/finance/finance.js?v=92',       html: 'finance/finance.html',       css: 'finance/finance.css' },
  journal:     { js: '../modules/journal/journal.js?v=92',       html: 'journal/journal.html',       css: 'journal/journal.css' },
  relations:   { js: '../modules/relations/relations.js?v=92',   html: 'relations/relations.html',   css: 'relations/relations.css' },
  knowledge:   { js: '../modules/knowledge/knowledge.js?v=92',   html: 'knowledge/knowledge.html',   css: 'knowledge/knowledge.css' },
  goals:       { js: '../modules/goals/goals.js?v=92',           html: 'goals/goals.html',           css: 'goals/goals.css' },
  lifetree:    { js: '../modules/lifetree/lifetree.js?v=92',     html: 'lifetree/lifetree.html',     css: 'lifetree/lifetree.css' },
  content:     { js: '../modules/content/content.js?v=92',       html: 'content/content.html',       css: 'content/content.css' },
  achievements:{ js: '../modules/achievements/achievements.js?v=92', html: 'achievements/achievements.html', css: 'achievements/achievements.css' },
  timetracker: { js: '../modules/timetracker/timetracker.js?v=92', html: 'timetracker/timetracker.html', css: 'timetracker/timetracker.css' },
  templates:   { js: '../modules/templates/templates_module.js?v=92', html: 'templates/templates.html' },
  calendar:    { js: '../modules/calendar/calendar.js?v=92',        html: 'calendar/calendar.html',     css: 'calendar/calendar.css' },
  toolbox:     { js: '../modules/toolbox/toolbox.js?v=92',          html: 'toolbox/toolbox.html',        css: 'toolbox/toolbox.css' },
  travel:      { js: '../modules/travel/travel.js?v=92',           html: 'travel/travel.html',           css: 'travel/travel.css' },
};
...
async function lazyImport(name) {
  ...
  const pathMap = {
    secureStorage: './secure-storage.js?v=92',
    theme: './theme.js?v=92',
    bgEffects: './bg-effects.js?v=92',
    notifications: './notifications.js?v=92',
    smartReminder: './smart-reminder.js?v=92',
    templates: './templates.js?v=92',
    userProfile: './user-profile.js?v=92',
    preferenceLearner: './preference-learner.js?v=92',
    predictiveEngine: './predictive-engine.js?v=92',
    auditLog: './audit-log.js?v=92',
    localAI: './local-ai.js?v=92',
    quickinput: './quickinput.js?v=92',
    sharedKnowledge: './shared-knowledge.js?v=92',
    orchestrator: './orchestrator.js?v=92',
    modelRouter: './model-router.js?v=92',
    smartSuggestion: './smart-suggestion.js?v=92',
    crossLinker: './cross-linker.js?v=92',
    sync: './sync.js?v=92',
    search: './search.js?v=92',
    export: './export.js?v=92',
    emotionAnalyzer: './emotion-analyzer.js?v=92',
    dataMinimizer: './data-minimizer.js?v=92',
    knowledgeExtractor: './knowledge-extractor.js?v=92',
    nicole: './nicole.js?v=92',
    xiaolu: './xiaolu.js?v=92',
    music: '../modules/music/music.js?v=92',
    report: '../modules/report/report.js?v=92',
    rest: '../modules/rest/rest.js?v=92',
    achievements: './achievements.js?v=92',
  };
