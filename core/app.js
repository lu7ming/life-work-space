...
const MODULE_REGISTRY = {
  dashboard:   { js: '../modules/dashboard/dashboard.js?v=79',   html: 'dashboard/dashboard.html',   css: 'dashboard/dashboard.css' },
  habits:      { js: '../modules/habits/habits.js?v=79',         html: 'habits/habits.html',         css: 'habits/habits.css' },
  tasks:       { js: '../modules/tasks/tasks.js?v=79',           html: 'tasks/tasks.html',           css: 'tasks/tasks.css' },
  study:       { js: '../modules/study/study.js?v=79',           html: 'study/study.html',           css: 'study/study.css' },
  health:      { js: '../modules/health/health.js?v=79',         html: 'health/health.html',         css: 'health/health.css' },
  finance:     { js: '../modules/finance/finance.js?v=79',       html: 'finance/finance.html',       css: 'finance/finance.css' },
  journal:     { js: '../modules/journal/journal.js?v=79',       html: 'journal/journal.html',       css: 'journal/journal.css' },
  relations:   { js: '../modules/relations/relations.js?v=79',   html: 'relations/relations.html',   css: 'relations/relations.css' },
  knowledge:   { js: '../modules/knowledge/knowledge.js?v=79',   html: 'knowledge/knowledge.html',   css: 'knowledge/knowledge.css' },
  goals:       { js: '../modules/goals/goals.js?v=79',           html: 'goals/goals.html',           css: 'goals/goals.css' },
  lifetree:    { js: '../modules/lifetree/lifetree.js?v=79',     html: 'lifetree/lifetree.html',     css: 'lifetree/lifetree.css' },
  content:     { js: '../modules/content/content.js?v=79',       html: 'content/content.html',       css: 'content/content.css' },
  achievements:{ js: '../modules/achievements/achievements.js?v=79', html: 'achievements/achievements.html', css: 'achievements/achievements.css' },
  timetracker: { js: '../modules/timetracker/timetracker.js?v=79', html: 'timetracker/timetracker.html', css: 'timetracker/timetracker.css' },
  templates:   { js: '../modules/templates/templates_module.js?v=79', html: 'templates/templates.html' },
  calendar:    { js: '../modules/calendar/calendar.js?v=79',        html: 'calendar/calendar.html',     css: 'calendar/calendar.css' },
  toolbox:     { js: '../modules/toolbox/toolbox.js?v=79',          html: 'toolbox/toolbox.html',        css: 'toolbox/toolbox.css' },
};
...
async function lazyImport(name) {
  ...
  const pathMap = {
    secureStorage: './secure-storage.js?v=79',
    theme: './theme.js?v=79',
    bgEffects: './bg-effects.js?v=79',
    notifications: './notifications.js?v=79',
    smartReminder: './smart-reminder.js?v=79',
    templates: './templates.js?v=79',
    userProfile: './user-profile.js?v=79',
    preferenceLearner: './preference-learner.js?v=79',
    predictiveEngine: './predictive-engine.js?v=79',
    auditLog: './audit-log.js?v=79',
    localAI: './local-ai.js?v=79',
    quickinput: './quickinput.js?v=79',
    sharedKnowledge: './shared-knowledge.js?v=79',
    orchestrator: './orchestrator.js?v=79',
    modelRouter: './model-router.js?v=79',
    smartSuggestion: './smart-suggestion.js?v=79',
    crossLinker: './cross-linker.js?v=79',
    sync: './sync.js?v=79',
    search: './search.js?v=79',
    export: './export.js?v=79',
    emotionAnalyzer: './emotion-analyzer.js?v=79',
    dataMinimizer: './data-minimizer.js?v=79',
    knowledgeExtractor: './knowledge-extractor.js?v=79',
    nicole: './nicole.js?v=79',
    xiaolu: './xiaolu.js?v=79',
    music: '../modules/music/music.js?v=79',
    report: '../modules/report/report.js?v=79',
    rest: '../modules/rest/rest.js?v=79',
    achievements: './achievements.js?v=79',
  };
