...
const MODULE_REGISTRY = {
  dashboard:   { js: '../modules/dashboard/dashboard.js?v=69',   html: 'dashboard/dashboard.html',   css: 'dashboard/dashboard.css' },
  habits:      { js: '../modules/habits/habits.js?v=69',         html: 'habits/habits.html',         css: 'habits/habits.css' },
  tasks:       { js: '../modules/tasks/tasks.js?v=69',           html: 'tasks/tasks.html',           css: 'tasks/tasks.css' },
  study:       { js: '../modules/study/study.js?v=69',           html: 'study/study.html',           css: 'study/study.css' },
  health:      { js: '../modules/health/health.js?v=69',         html: 'health/health.html',         css: 'health/health.css' },
  finance:     { js: '../modules/finance/finance.js?v=69',       html: 'finance/finance.html',       css: 'finance/finance.css' },
  journal:     { js: '../modules/journal/journal.js?v=69',       html: 'journal/journal.html',       css: 'journal/journal.css' },
  relations:   { js: '../modules/relations/relations.js?v=69',   html: 'relations/relations.html',   css: 'relations/relations.css' },
  knowledge:   { js: '../modules/knowledge/knowledge.js?v=69',   html: 'knowledge/knowledge.html',   css: 'knowledge/knowledge.css' },
  goals:       { js: '../modules/goals/goals.js?v=69',           html: 'goals/goals.html',           css: 'goals/goals.css' },
  lifetree:    { js: '../modules/lifetree/lifetree.js?v=69',     html: 'lifetree/lifetree.html',     css: 'lifetree/lifetree.css' },
  content:     { js: '../modules/content/content.js?v=69',       html: 'content/content.html',       css: 'content/content.css' },
  achievements:{ js: '../modules/achievements/achievements.js?v=69', html: 'achievements/achievements.html', css: 'achievements/achievements.css' },
  timetracker: { js: '../modules/timetracker/timetracker.js?v=69', html: 'timetracker/timetracker.html', css: 'timetracker/timetracker.css' },
  templates:   { js: '../modules/templates/templates_module.js?v=69', html: 'templates/templates.html' },
  calendar:    { js: '../modules/calendar/calendar.js?v=69',        html: 'calendar/calendar.html',     css: 'calendar/calendar.css' },
};
...
async function lazyImport(name) {
  ...
  const pathMap = {
    secureStorage: './secure-storage.js?v=69',
    theme: './theme.js?v=69',
    notifications: './notifications.js?v=69',
    smartReminder: './smart-reminder.js?v=69',
    templates: './templates.js?v=69',
    userProfile: './user-profile.js?v=69',
    preferenceLearner: './preference-learner.js?v=69',
    predictiveEngine: './predictive-engine.js?v=69',
    auditLog: './audit-log.js?v=69',
    localAI: './local-ai.js?v=69',
    quickinput: './quickinput.js?v=69',
    sharedKnowledge: './shared-knowledge.js?v=69',
    orchestrator: './orchestrator.js?v=69',
    modelRouter: './model-router.js?v=69',
    smartSuggestion: './smart-suggestion.js?v=69',
    crossLinker: './cross-linker.js?v=69',
    sync: './sync.js?v=69',
    search: './search.js?v=69',
    export: './export.js?v=69',
    emotionAnalyzer: './emotion-analyzer.js?v=69',
    dataMinimizer: './data-minimizer.js?v=69',
    knowledgeExtractor: './knowledge-extractor.js?v=69',
    nicole: './nicole.js?v=69',
    xiaolu: './xiaolu.js?v=69',
    whitenoise: '../modules/whitenoise/whitenoise.js?v=69',
    report: '../modules/report/report.js?v=69',
    rest: '../modules/rest/rest.js?v=69',
    achievements: './achievements.js?v=69',
  };
