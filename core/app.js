...
const MODULE_REGISTRY = {
  dashboard:   { js: '../modules/dashboard/dashboard.js?v=83',   html: 'dashboard/dashboard.html',   css: 'dashboard/dashboard.css' },
  habits:      { js: '../modules/habits/habits.js?v=83',         html: 'habits/habits.html',         css: 'habits/habits.css' },
  tasks:       { js: '../modules/tasks/tasks.js?v=83',           html: 'tasks/tasks.html',           css: 'tasks/tasks.css' },
  study:       { js: '../modules/study/study.js?v=83',           html: 'study/study.html',           css: 'study/study.css' },
  health:      { js: '../modules/health/health.js?v=83',         html: 'health/health.html',         css: 'health/health.css' },
  finance:     { js: '../modules/finance/finance.js?v=83',       html: 'finance/finance.html',       css: 'finance/finance.css' },
  journal:     { js: '../modules/journal/journal.js?v=83',       html: 'journal/journal.html',       css: 'journal/journal.css' },
  relations:   { js: '../modules/relations/relations.js?v=83',   html: 'relations/relations.html',   css: 'relations/relations.css' },
  knowledge:   { js: '../modules/knowledge/knowledge.js?v=83',   html: 'knowledge/knowledge.html',   css: 'knowledge/knowledge.css' },
  goals:       { js: '../modules/goals/goals.js?v=83',           html: 'goals/goals.html',           css: 'goals/goals.css' },
  lifetree:    { js: '../modules/lifetree/lifetree.js?v=83',     html: 'lifetree/lifetree.html',     css: 'lifetree/lifetree.css' },
  content:     { js: '../modules/content/content.js?v=83',       html: 'content/content.html',       css: 'content/content.css' },
  achievements:{ js: '../modules/achievements/achievements.js?v=83', html: 'achievements/achievements.html', css: 'achievements/achievements.css' },
  timetracker: { js: '../modules/timetracker/timetracker.js?v=83', html: 'timetracker/timetracker.html', css: 'timetracker/timetracker.css' },
  templates:   { js: '../modules/templates/templates_module.js?v=83', html: 'templates/templates.html' },
  calendar:    { js: '../modules/calendar/calendar.js?v=83',        html: 'calendar/calendar.html',     css: 'calendar/calendar.css' },
  toolbox:     { js: '../modules/toolbox/toolbox.js?v=83',          html: 'toolbox/toolbox.html',        css: 'toolbox/toolbox.css' },
};
...
async function lazyImport(name) {
  ...
  const pathMap = {
    secureStorage: './secure-storage.js?v=83',
    theme: './theme.js?v=83',
    bgEffects: './bg-effects.js?v=83',
    notifications: './notifications.js?v=83',
    smartReminder: './smart-reminder.js?v=83',
    templates: './templates.js?v=83',
    userProfile: './user-profile.js?v=83',
    preferenceLearner: './preference-learner.js?v=83',
    predictiveEngine: './predictive-engine.js?v=83',
    auditLog: './audit-log.js?v=83',
    localAI: './local-ai.js?v=83',
    quickinput: './quickinput.js?v=83',
    sharedKnowledge: './shared-knowledge.js?v=83',
    orchestrator: './orchestrator.js?v=83',
    modelRouter: './model-router.js?v=83',
    smartSuggestion: './smart-suggestion.js?v=83',
    crossLinker: './cross-linker.js?v=83',
    sync: './sync.js?v=83',
    search: './search.js?v=83',
    export: './export.js?v=83',
    emotionAnalyzer: './emotion-analyzer.js?v=83',
    dataMinimizer: './data-minimizer.js?v=83',
    knowledgeExtractor: './knowledge-extractor.js?v=83',
    nicole: './nicole.js?v=83',
    xiaolu: './xiaolu.js?v=83',
    music: '../modules/music/music.js?v=83',
    report: '../modules/report/report.js?v=83',
    rest: '../modules/rest/rest.js?v=83',
    achievements: './achievements.js?v=83',
  };
