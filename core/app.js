...
const MODULE_REGISTRY = {
  dashboard:   { js: '../modules/dashboard/dashboard.js?v=94',   html: 'dashboard/dashboard.html',   css: 'dashboard/dashboard.css' },
  habits:      { js: '../modules/habits/habits.js?v=94',         html: 'habits/habits.html',         css: 'habits/habits.css' },
  tasks:       { js: '../modules/tasks/tasks.js?v=94',           html: 'tasks/tasks.html',           css: 'tasks/tasks.css' },
  study:       { js: '../modules/study/study.js?v=94',           html: 'study/study.html',           css: 'study/study.css' },
  health:      { js: '../modules/health/health.js?v=94',         html: 'health/health.html',         css: 'health/health.css' },
  finance:     { js: '../modules/finance/finance.js?v=94',       html: 'finance/finance.html',       css: 'finance/finance.css' },
  journal:     { js: '../modules/journal/journal.js?v=94',       html: 'journal/journal.html',       css: 'journal/journal.css' },
  relations:   { js: '../modules/relations/relations.js?v=94',   html: 'relations/relations.html',   css: 'relations/relations.css' },
  knowledge:   { js: '../modules/knowledge/knowledge.js?v=94',   html: 'knowledge/knowledge.html',   css: 'knowledge/knowledge.css' },
  goals:       { js: '../modules/goals/goals.js?v=94',           html: 'goals/goals.html',           css: 'goals/goals.css' },
  lifetree:    { js: '../modules/lifetree/lifetree.js?v=94',     html: 'lifetree/lifetree.html',     css: 'lifetree/lifetree.css' },
  content:     { js: '../modules/content/content.js?v=94',       html: 'content/content.html',       css: 'content/content.css' },
  achievements:{ js: '../modules/achievements/achievements.js?v=94', html: 'achievements/achievements.html', css: 'achievements/achievements.css' },
  timetracker: { js: '../modules/timetracker/timetracker.js?v=94', html: 'timetracker/timetracker.html', css: 'timetracker/timetracker.css' },
  templates:   { js: '../modules/templates/templates_module.js?v=94', html: 'templates/templates.html' },
  calendar:    { js: '../modules/calendar/calendar.js?v=94',        html: 'calendar/calendar.html',     css: 'calendar/calendar.css' },
  toolbox:     { js: '../modules/toolbox/toolbox.js?v=94',          html: 'toolbox/toolbox.html',        css: 'toolbox/toolbox.css' },
  travel:      { js: '../modules/travel/travel.js?v=94',           html: 'travel/travel.html',           css: 'travel/travel.css' },
};
...
async function lazyImport(name) {
  ...
  const pathMap = {
    secureStorage: './secure-storage.js?v=94',
    theme: './theme.js?v=94',
    bgEffects: './bg-effects.js?v=94',
    notifications: './notifications.js?v=94',
    smartReminder: './smart-reminder.js?v=94',
    templates: './templates.js?v=94',
    userProfile: './user-profile.js?v=94',
    preferenceLearner: './preference-learner.js?v=94',
    predictiveEngine: './predictive-engine.js?v=94',
    auditLog: './audit-log.js?v=94',
    localAI: './local-ai.js?v=94',
    quickinput: './quickinput.js?v=94',
    sharedKnowledge: './shared-knowledge.js?v=94',
    orchestrator: './orchestrator.js?v=94',
    modelRouter: './model-router.js?v=94',
    smartSuggestion: './smart-suggestion.js?v=94',
    crossLinker: './cross-linker.js?v=94',
    sync: './sync.js?v=94',
    search: './search.js?v=94',
    export: './export.js?v=94',
    emotionAnalyzer: './emotion-analyzer.js?v=94',
    dataMinimizer: './data-minimizer.js?v=94',
    knowledgeExtractor: './knowledge-extractor.js?v=94',
    nicole: './nicole.js?v=94',
    xiaolu: './xiaolu.js?v=94',
    music: '../modules/music/music.js?v=94',
    report: '../modules/report/report.js?v=94',
    rest: '../modules/rest/rest.js?v=94',
    achievements: './achievements.js?v=94',
  };
