...
const MODULE_REGISTRY = {
  dashboard:   { js: '../modules/dashboard/dashboard.js?v=89',   html: 'dashboard/dashboard.html',   css: 'dashboard/dashboard.css' },
  habits:      { js: '../modules/habits/habits.js?v=89',         html: 'habits/habits.html',         css: 'habits/habits.css' },
  tasks:       { js: '../modules/tasks/tasks.js?v=89',           html: 'tasks/tasks.html',           css: 'tasks/tasks.css' },
  study:       { js: '../modules/study/study.js?v=89',           html: 'study/study.html',           css: 'study/study.css' },
  health:      { js: '../modules/health/health.js?v=89',         html: 'health/health.html',         css: 'health/health.css' },
  finance:     { js: '../modules/finance/finance.js?v=89',       html: 'finance/finance.html',       css: 'finance/finance.css' },
  journal:     { js: '../modules/journal/journal.js?v=89',       html: 'journal/journal.html',       css: 'journal/journal.css' },
  relations:   { js: '../modules/relations/relations.js?v=89',   html: 'relations/relations.html',   css: 'relations/relations.css' },
  knowledge:   { js: '../modules/knowledge/knowledge.js?v=89',   html: 'knowledge/knowledge.html',   css: 'knowledge/knowledge.css' },
  goals:       { js: '../modules/goals/goals.js?v=89',           html: 'goals/goals.html',           css: 'goals/goals.css' },
  lifetree:    { js: '../modules/lifetree/lifetree.js?v=89',     html: 'lifetree/lifetree.html',     css: 'lifetree/lifetree.css' },
  content:     { js: '../modules/content/content.js?v=89',       html: 'content/content.html',       css: 'content/content.css' },
  achievements:{ js: '../modules/achievements/achievements.js?v=89', html: 'achievements/achievements.html', css: 'achievements/achievements.css' },
  timetracker: { js: '../modules/timetracker/timetracker.js?v=89', html: 'timetracker/timetracker.html', css: 'timetracker/timetracker.css' },
  templates:   { js: '../modules/templates/templates_module.js?v=89', html: 'templates/templates.html' },
  calendar:    { js: '../modules/calendar/calendar.js?v=89',        html: 'calendar/calendar.html',     css: 'calendar/calendar.css' },
  toolbox:     { js: '../modules/toolbox/toolbox.js?v=89',          html: 'toolbox/toolbox.html',        css: 'toolbox/toolbox.css' },
  travel:      { js: '../modules/travel/travel.js?v=89',           html: 'travel/travel.html',           css: 'travel/travel.css' },
};
...
async function lazyImport(name) {
  ...
  const pathMap = {
    secureStorage: './secure-storage.js?v=89',
    theme: './theme.js?v=89',
    bgEffects: './bg-effects.js?v=89',
    notifications: './notifications.js?v=89',
    smartReminder: './smart-reminder.js?v=89',
    templates: './templates.js?v=89',
    userProfile: './user-profile.js?v=89',
    preferenceLearner: './preference-learner.js?v=89',
    predictiveEngine: './predictive-engine.js?v=89',
    auditLog: './audit-log.js?v=89',
    localAI: './local-ai.js?v=89',
    quickinput: './quickinput.js?v=89',
    sharedKnowledge: './shared-knowledge.js?v=89',
    orchestrator: './orchestrator.js?v=89',
    modelRouter: './model-router.js?v=89',
    smartSuggestion: './smart-suggestion.js?v=89',
    crossLinker: './cross-linker.js?v=89',
    sync: './sync.js?v=89',
    search: './search.js?v=89',
    export: './export.js?v=89',
    emotionAnalyzer: './emotion-analyzer.js?v=89',
    dataMinimizer: './data-minimizer.js?v=89',
    knowledgeExtractor: './knowledge-extractor.js?v=89',
    nicole: './nicole.js?v=89',
    xiaolu: './xiaolu.js?v=89',
    music: '../modules/music/music.js?v=89',
    report: '../modules/report/report.js?v=89',
    rest: '../modules/rest/rest.js?v=89',
    achievements: './achievements.js?v=89',
  };
