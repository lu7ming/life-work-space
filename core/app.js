...
const MODULE_REGISTRY = {
  dashboard:   { js: '../modules/dashboard/dashboard.js?v=78',   html: 'dashboard/dashboard.html',   css: 'dashboard/dashboard.css' },
  habits:      { js: '../modules/habits/habits.js?v=78',         html: 'habits/habits.html',         css: 'habits/habits.css' },
  tasks:       { js: '../modules/tasks/tasks.js?v=78',           html: 'tasks/tasks.html',           css: 'tasks/tasks.css' },
  study:       { js: '../modules/study/study.js?v=78',           html: 'study/study.html',           css: 'study/study.css' },
  health:      { js: '../modules/health/health.js?v=78',         html: 'health/health.html',         css: 'health/health.css' },
  finance:     { js: '../modules/finance/finance.js?v=78',       html: 'finance/finance.html',       css: 'finance/finance.css' },
  journal:     { js: '../modules/journal/journal.js?v=78',       html: 'journal/journal.html',       css: 'journal/journal.css' },
  relations:   { js: '../modules/relations/relations.js?v=78',   html: 'relations/relations.html',   css: 'relations/relations.css' },
  knowledge:   { js: '../modules/knowledge/knowledge.js?v=78',   html: 'knowledge/knowledge.html',   css: 'knowledge/knowledge.css' },
  goals:       { js: '../modules/goals/goals.js?v=78',           html: 'goals/goals.html',           css: 'goals/goals.css' },
  lifetree:    { js: '../modules/lifetree/lifetree.js?v=78',     html: 'lifetree/lifetree.html',     css: 'lifetree/lifetree.css' },
  content:     { js: '../modules/content/content.js?v=78',       html: 'content/content.html',       css: 'content/content.css' },
  achievements:{ js: '../modules/achievements/achievements.js?v=78', html: 'achievements/achievements.html', css: 'achievements/achievements.css' },
  timetracker: { js: '../modules/timetracker/timetracker.js?v=78', html: 'timetracker/timetracker.html', css: 'timetracker/timetracker.css' },
  templates:   { js: '../modules/templates/templates_module.js?v=78', html: 'templates/templates.html' },
  calendar:    { js: '../modules/calendar/calendar.js?v=78',        html: 'calendar/calendar.html',     css: 'calendar/calendar.css' },
  toolbox:     { js: '../modules/toolbox/toolbox.js?v=78',          html: 'toolbox/toolbox.html',        css: 'toolbox/toolbox.css' },
};
...
async function lazyImport(name) {
  ...
  const pathMap = {
    secureStorage: './secure-storage.js?v=78',
    theme: './theme.js?v=78',
    bgEffects: './bg-effects.js?v=78',
    notifications: './notifications.js?v=78',
    smartReminder: './smart-reminder.js?v=78',
    templates: './templates.js?v=78',
    userProfile: './user-profile.js?v=78',
    preferenceLearner: './preference-learner.js?v=78',
    predictiveEngine: './predictive-engine.js?v=78',
    auditLog: './audit-log.js?v=78',
    localAI: './local-ai.js?v=78',
    quickinput: './quickinput.js?v=78',
    sharedKnowledge: './shared-knowledge.js?v=78',
    orchestrator: './orchestrator.js?v=78',
    modelRouter: './model-router.js?v=78',
    smartSuggestion: './smart-suggestion.js?v=78',
    crossLinker: './cross-linker.js?v=78',
    sync: './sync.js?v=78',
    search: './search.js?v=78',
    export: './export.js?v=78',
    emotionAnalyzer: './emotion-analyzer.js?v=78',
    dataMinimizer: './data-minimizer.js?v=78',
    knowledgeExtractor: './knowledge-extractor.js?v=78',
    nicole: './nicole.js?v=78',
    xiaolu: './xiaolu.js?v=78',
    music: '../modules/music/music.js?v=78',
    report: '../modules/report/report.js?v=78',
    rest: '../modules/rest/rest.js?v=78',
    achievements: './achievements.js?v=78',
  };
