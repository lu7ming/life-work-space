...
const MODULE_REGISTRY = {
  dashboard:   { js: '../modules/dashboard/dashboard.js?v=76',   html: 'dashboard/dashboard.html',   css: 'dashboard/dashboard.css' },
  habits:      { js: '../modules/habits/habits.js?v=76',         html: 'habits/habits.html',         css: 'habits/habits.css' },
  tasks:       { js: '../modules/tasks/tasks.js?v=76',           html: 'tasks/tasks.html',           css: 'tasks/tasks.css' },
  study:       { js: '../modules/study/study.js?v=76',           html: 'study/study.html',           css: 'study/study.css' },
  health:      { js: '../modules/health/health.js?v=76',         html: 'health/health.html',         css: 'health/health.css' },
  finance:     { js: '../modules/finance/finance.js?v=76',       html: 'finance/finance.html',       css: 'finance/finance.css' },
  journal:     { js: '../modules/journal/journal.js?v=76',       html: 'journal/journal.html',       css: 'journal/journal.css' },
  relations:   { js: '../modules/relations/relations.js?v=76',   html: 'relations/relations.html',   css: 'relations/relations.css' },
  knowledge:   { js: '../modules/knowledge/knowledge.js?v=76',   html: 'knowledge/knowledge.html',   css: 'knowledge/knowledge.css' },
  goals:       { js: '../modules/goals/goals.js?v=76',           html: 'goals/goals.html',           css: 'goals/goals.css' },
  lifetree:    { js: '../modules/lifetree/lifetree.js?v=76',     html: 'lifetree/lifetree.html',     css: 'lifetree/lifetree.css' },
  content:     { js: '../modules/content/content.js?v=76',       html: 'content/content.html',       css: 'content/content.css' },
  achievements:{ js: '../modules/achievements/achievements.js?v=76', html: 'achievements/achievements.html', css: 'achievements/achievements.css' },
  timetracker: { js: '../modules/timetracker/timetracker.js?v=76', html: 'timetracker/timetracker.html', css: 'timetracker/timetracker.css' },
  templates:   { js: '../modules/templates/templates_module.js?v=76', html: 'templates/templates.html' },
  calendar:    { js: '../modules/calendar/calendar.js?v=76',        html: 'calendar/calendar.html',     css: 'calendar/calendar.css' },
  toolbox:     { js: '../modules/toolbox/toolbox.js?v=76',          html: 'toolbox/toolbox.html',        css: 'toolbox/toolbox.css' },
};
...
async function lazyImport(name) {
  ...
  const pathMap = {
    secureStorage: './secure-storage.js?v=76',
    theme: './theme.js?v=76',
    bgEffects: './bg-effects.js?v=76',
    notifications: './notifications.js?v=76',
    smartReminder: './smart-reminder.js?v=76',
    templates: './templates.js?v=76',
    userProfile: './user-profile.js?v=76',
    preferenceLearner: './preference-learner.js?v=76',
    predictiveEngine: './predictive-engine.js?v=76',
    auditLog: './audit-log.js?v=76',
    localAI: './local-ai.js?v=76',
    quickinput: './quickinput.js?v=76',
    sharedKnowledge: './shared-knowledge.js?v=76',
    orchestrator: './orchestrator.js?v=76',
    modelRouter: './model-router.js?v=76',
    smartSuggestion: './smart-suggestion.js?v=76',
    crossLinker: './cross-linker.js?v=76',
    sync: './sync.js?v=76',
    search: './search.js?v=76',
    export: './export.js?v=76',
    emotionAnalyzer: './emotion-analyzer.js?v=76',
    dataMinimizer: './data-minimizer.js?v=76',
    knowledgeExtractor: './knowledge-extractor.js?v=76',
    nicole: './nicole.js?v=76',
    xiaolu: './xiaolu.js?v=76',
    music: '../modules/music/music.js?v=76',
    report: '../modules/report/report.js?v=76',
    rest: '../modules/rest/rest.js?v=76',
    achievements: './achievements.js?v=76',
  };
