...
const MODULE_REGISTRY = {
  dashboard:   { js: '../modules/dashboard/dashboard.js?v=73',   html: 'dashboard/dashboard.html',   css: 'dashboard/dashboard.css' },
  habits:      { js: '../modules/habits/habits.js?v=73',         html: 'habits/habits.html',         css: 'habits/habits.css' },
  tasks:       { js: '../modules/tasks/tasks.js?v=73',           html: 'tasks/tasks.html',           css: 'tasks/tasks.css' },
  study:       { js: '../modules/study/study.js?v=73',           html: 'study/study.html',           css: 'study/study.css' },
  health:      { js: '../modules/health/health.js?v=73',         html: 'health/health.html',         css: 'health/health.css' },
  finance:     { js: '../modules/finance/finance.js?v=73',       html: 'finance/finance.html',       css: 'finance/finance.css' },
  journal:     { js: '../modules/journal/journal.js?v=73',       html: 'journal/journal.html',       css: 'journal/journal.css' },
  relations:   { js: '../modules/relations/relations.js?v=73',   html: 'relations/relations.html',   css: 'relations/relations.css' },
  knowledge:   { js: '../modules/knowledge/knowledge.js?v=73',   html: 'knowledge/knowledge.html',   css: 'knowledge/knowledge.css' },
  goals:       { js: '../modules/goals/goals.js?v=73',           html: 'goals/goals.html',           css: 'goals/goals.css' },
  lifetree:    { js: '../modules/lifetree/lifetree.js?v=73',     html: 'lifetree/lifetree.html',     css: 'lifetree/lifetree.css' },
  content:     { js: '../modules/content/content.js?v=73',       html: 'content/content.html',       css: 'content/content.css' },
  achievements:{ js: '../modules/achievements/achievements.js?v=73', html: 'achievements/achievements.html', css: 'achievements/achievements.css' },
  timetracker: { js: '../modules/timetracker/timetracker.js?v=73', html: 'timetracker/timetracker.html', css: 'timetracker/timetracker.css' },
  templates:   { js: '../modules/templates/templates_module.js?v=73', html: 'templates/templates.html' },
  calendar:    { js: '../modules/calendar/calendar.js?v=73',        html: 'calendar/calendar.html',     css: 'calendar/calendar.css' },
  toolbox:     { js: '../modules/toolbox/toolbox.js?v=73',          html: 'toolbox/toolbox.html',        css: 'toolbox/toolbox.css' },
};
...
async function lazyImport(name) {
  ...
  const pathMap = {
    secureStorage: './secure-storage.js?v=73',
    theme: './theme.js?v=73',
    bgEffects: './bg-effects.js?v=73',
    notifications: './notifications.js?v=73',
    smartReminder: './smart-reminder.js?v=73',
    templates: './templates.js?v=73',
    userProfile: './user-profile.js?v=73',
    preferenceLearner: './preference-learner.js?v=73',
    predictiveEngine: './predictive-engine.js?v=73',
    auditLog: './audit-log.js?v=73',
    localAI: './local-ai.js?v=73',
    quickinput: './quickinput.js?v=73',
    sharedKnowledge: './shared-knowledge.js?v=73',
    orchestrator: './orchestrator.js?v=73',
    modelRouter: './model-router.js?v=73',
    smartSuggestion: './smart-suggestion.js?v=73',
    crossLinker: './cross-linker.js?v=73',
    sync: './sync.js?v=73',
    search: './search.js?v=73',
    export: './export.js?v=73',
    emotionAnalyzer: './emotion-analyzer.js?v=73',
    dataMinimizer: './data-minimizer.js?v=73',
    knowledgeExtractor: './knowledge-extractor.js?v=73',
    nicole: './nicole.js?v=73',
    xiaolu: './xiaolu.js?v=73',
    music: '../modules/music/music.js?v=73',
    report: '../modules/report/report.js?v=73',
    rest: '../modules/rest/rest.js?v=73',
    achievements: './achievements.js?v=73',
  };
