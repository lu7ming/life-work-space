...
const MODULE_REGISTRY = {
  dashboard:   { js: '../modules/dashboard/dashboard.js?v=91',   html: 'dashboard/dashboard.html',   css: 'dashboard/dashboard.css' },
  habits:      { js: '../modules/habits/habits.js?v=91',         html: 'habits/habits.html',         css: 'habits/habits.css' },
  tasks:       { js: '../modules/tasks/tasks.js?v=91',           html: 'tasks/tasks.html',           css: 'tasks/tasks.css' },
  study:       { js: '../modules/study/study.js?v=91',           html: 'study/study.html',           css: 'study/study.css' },
  health:      { js: '../modules/health/health.js?v=91',         html: 'health/health.html',         css: 'health/health.css' },
  finance:     { js: '../modules/finance/finance.js?v=91',       html: 'finance/finance.html',       css: 'finance/finance.css' },
  journal:     { js: '../modules/journal/journal.js?v=91',       html: 'journal/journal.html',       css: 'journal/journal.css' },
  relations:   { js: '../modules/relations/relations.js?v=91',   html: 'relations/relations.html',   css: 'relations/relations.css' },
  knowledge:   { js: '../modules/knowledge/knowledge.js?v=91',   html: 'knowledge/knowledge.html',   css: 'knowledge/knowledge.css' },
  goals:       { js: '../modules/goals/goals.js?v=91',           html: 'goals/goals.html',           css: 'goals/goals.css' },
  lifetree:    { js: '../modules/lifetree/lifetree.js?v=91',     html: 'lifetree/lifetree.html',     css: 'lifetree/lifetree.css' },
  content:     { js: '../modules/content/content.js?v=91',       html: 'content/content.html',       css: 'content/content.css' },
  achievements:{ js: '../modules/achievements/achievements.js?v=91', html: 'achievements/achievements.html', css: 'achievements/achievements.css' },
  timetracker: { js: '../modules/timetracker/timetracker.js?v=91', html: 'timetracker/timetracker.html', css: 'timetracker/timetracker.css' },
  templates:   { js: '../modules/templates/templates_module.js?v=91', html: 'templates/templates.html' },
  calendar:    { js: '../modules/calendar/calendar.js?v=91',        html: 'calendar/calendar.html',     css: 'calendar/calendar.css' },
  toolbox:     { js: '../modules/toolbox/toolbox.js?v=91',          html: 'toolbox/toolbox.html',        css: 'toolbox/toolbox.css' },
  travel:      { js: '../modules/travel/travel.js?v=91',           html: 'travel/travel.html',           css: 'travel/travel.css' },
};
...
async function lazyImport(name) {
  ...
  const pathMap = {
    secureStorage: './secure-storage.js?v=91',
    theme: './theme.js?v=91',
    bgEffects: './bg-effects.js?v=91',
    notifications: './notifications.js?v=91',
    smartReminder: './smart-reminder.js?v=91',
    templates: './templates.js?v=91',
    userProfile: './user-profile.js?v=91',
    preferenceLearner: './preference-learner.js?v=91',
    predictiveEngine: './predictive-engine.js?v=91',
    auditLog: './audit-log.js?v=91',
    localAI: './local-ai.js?v=91',
    quickinput: './quickinput.js?v=91',
    sharedKnowledge: './shared-knowledge.js?v=91',
    orchestrator: './orchestrator.js?v=91',
    modelRouter: './model-router.js?v=91',
    smartSuggestion: './smart-suggestion.js?v=91',
    crossLinker: './cross-linker.js?v=91',
    sync: './sync.js?v=91',
    search: './search.js?v=91',
    export: './export.js?v=91',
    emotionAnalyzer: './emotion-analyzer.js?v=91',
    dataMinimizer: './data-minimizer.js?v=91',
    knowledgeExtractor: './knowledge-extractor.js?v=91',
    nicole: './nicole.js?v=91',
    xiaolu: './xiaolu.js?v=91',
    music: '../modules/music/music.js?v=91',
    report: '../modules/report/report.js?v=91',
    rest: '../modules/rest/rest.js?v=91',
    achievements: './achievements.js?v=91',
  };
