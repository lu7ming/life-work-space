/**
 * visual-enhancements.js - 统一视觉增强 JS 逻辑（A+C 组合并）
 * 人生工作台 · v124
 *
 * A组（7项）：季节装饰Canvas、山水视差滚动、模块SVG插画注入、Toast动画增强等
 * C组（2项）：卷轴展开卡片、手绘风分隔元素（印章+毛笔分隔线）
 *
 * 导出：VisualEnhancements / VisualCGroup
 */
